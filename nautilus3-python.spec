Summary:	Python bindings for GNOME nautilus 3
Summary(pl.UTF-8):	Wiązania Pythona dla Nautilusa 3 z GNOME
Name:		nautilus3-python
Version:	1.2.3
Release:	2
License:	GPL v2+
Group:		Libraries
Source0:	https://download.gnome.org/sources/nautilus-python/1.2/nautilus-python-%{version}.tar.xz
...
Group:		Documentation
Conflicts:	nautilus-python-apidocs
BuildArch:	noarch
